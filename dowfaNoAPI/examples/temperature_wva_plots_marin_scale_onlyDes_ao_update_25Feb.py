...
def main():
    ...
    plt.plot(tA, out_co2_A["T"], linewidth=2.5, color="black", label="CO₂ 92.7 Mt/y (Marin & Kleinberg (2025))")
    plt.plot(tA, out_des_A["T"], linewidth=2.5, color="red", label="Desflurane 13,200 t/y (Marin & Kleinberg (2025))")
    ...
    for r in routes:
        ...
        line, = plt.plot(t, med, linewidth=2, label=label_text)
    ...
    plt.tight_layout()
    plt.savefig("../FIGURES/contOnlyDeswva.png", dpi=1200, bbox_inches="tight")
    #plt.show()
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig("../FIGURES/cease50yearsOnlyDeswva.png", dpi=1200, bbox_inches="tight")
    #plt.show()
